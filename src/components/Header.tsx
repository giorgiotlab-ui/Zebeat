    ...
    <header className="sticky top-0 z-20 bg-black/70 backdrop-blur border-b border-white/10">
      ...
      <div
        className={`md:hidden transform transition-all duration-300 origin-top ${
          open
            ? 'border-t border-white/10 bg-black/80 backdrop-blur scale-y-100 opacity-100'
            : 'border-t border-transparent bg-transparent backdrop-blur-0 scale-y-0 opacity-0 pointer-events-none'
        }`}
      >
